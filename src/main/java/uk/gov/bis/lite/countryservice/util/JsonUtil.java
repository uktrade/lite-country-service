package uk.gov.bis.lite.countryservice.util;
...
public class JsonUtil {
  ...
  public static String convertListToJson(List<String> list) {
    try {
      ...
      throw new CountryServiceException("Failed to parse list as JSON.", e);
    }
  }
  ...
  public static List<String> convertJsonToList(String json) {
    try {
      ...
      throw new CountryServiceException("Failed to parse JSON as list.", e);
    }
  }
